...
public class Cuenta {
	...
	public void realizarReintegro(double reintegro) {
		if (reintegro <= 0)
			...
			System.out.println("El reintegro solo puede realizarse con cantidades positivas.");
		else {
	...
	public void realizarIngreso(double ingreso) {
		if (ingreso <= 0)
			// Debería tratarse en una excepción
			System.out.println("El ingreso solo puede realizarse con cantidades positivas.");
		else {
	...
	public String toString() {
		return "Cuenta con saldo " + saldo + " .Se han realizado " + contadorIngresos + " ingresos y "
				+ contadorReintegros + " reintegros.";
	}
}